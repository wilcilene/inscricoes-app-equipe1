...
class EditalSeeder extends Seeder
{
    public function run(): void
    {
        for ($i = 769; $i <= 778; $i++) {
            ...
            $inicio = Carbon::create(2026, 5, 10)->addDays(($i - 769) * 7);

            Edital::create([
                'nome' => "{$i}/2026",
                'descricao' => "Edital institucional{$i}/2026",
                'resumo' => "Descrição do edital {$i}/2026 para processo seletivo e cadastro reserva.",
